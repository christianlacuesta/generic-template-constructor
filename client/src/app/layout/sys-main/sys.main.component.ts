...
@Component({
    selector: 'sys-main',
    templateUrl: './sys.main.component.html'
})
export class SysMainComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    constructor(public renderer: Renderer2, private menuService: SysMenuService, private primengConfig: PrimeNGConfig,
