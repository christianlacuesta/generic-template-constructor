        ...
        <ng-container>
            ...
            <ul *ngIf="((item.items && root) || (item.items && active)) && item.visible !== false" [@children]="root ? 'visible' : active ? 'visibleAnimated' : 'hiddenAnimated'">
                <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
                    <li sys-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>
                </ng-template>
            </ul>
        </ng-container>
    `,
...
export class SysMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public app: SysMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: SysMenuService) {
